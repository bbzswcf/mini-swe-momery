...
subcommands = [
    ...
    ("minisweagent.run.utilities.memory_eval", ["memory-eval"], "Analyze memory usage and transfer in experiment outputs"),
    ...
    (
        "minisweagent.run.benchmarks.swebench_chain_window",
        ["swebench-chain-window"],
        "Evaluate SWE-bench-Pro chains in a single LLM context window with threshold-triggered compression",
    ),
]
